...
import styles from './BuySellAuthenticationScreenStyle'
...
/**
 * User can complete their security options for payment here for money transfer
 */
export class BuySellAuthenticationScreen extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
    ...
    return (
      ...
      >
        ...
        {verified ? (
          ...
          <View>
            <Text style={styles.infoText}>
              {!isSMS ? I18n.t('SEND_TFA_INFO') : I18n.t('SEND_SMS_INFO')}
...
BuySellAuthenticationScreen.propTypes = {
