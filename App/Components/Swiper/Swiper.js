...
/* eslint-disable */
/*
 * Customized thirdparty component for swiper
 *
 * lint is disabled to prevent Unvanted props validations because this third party have lot's of line.
 * The Provider didn'd write any testcases and props validations
 *
 * source: https://github.com/leecade/react-native-swiper
 */
...
/**
 * Customized third party (react-native-swiper) for pagerView
 */
export default class extends Component {
  ...
  renderPagination = () => {
    ...
    for (let i = 0; i < this.state.total; i++) {
      dots.push(
        i === this.state.index
          ? this.renderActiveDot(this.props.dots[i], i)
          : this.renderNormalDot(this.props.dots[i], i)
      )
    }
  ...
  renderNormalDot = (text, index) => {
    return (
      <TouchableOpacity
        style={Platform.OS === 'android' ? styles.margins : {}}
        onPress={() => this.onDotClicked(index)}
      >
        <View style={styles.dotNormalContainer}>
          <Text style={styles.normalDotText}>{text}</Text>
        </View>
      </TouchableOpacity>
    )
  }
  renderActiveDot = (text, index) => {
    return (
      <View style={[styles.dotActiveContainer, Platform.OS === 'android' ? styles.margins : {}]}>
        <Text style={styles.activeDotText}>{text}</Text>
      </View>
    )
  }
  ...
  renderWalletTitle = () => {
    return (
      <View style={styles.walletTitleContainer}>
        ...
        <Text style={styles.walletTitleText}>{this.props.viewTitles[this.state.index]}</Text>
      </View>
    )
  }
